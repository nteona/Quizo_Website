...
<ul>
  ...
  <li style="float:left"><a href="student_page.php">Quizzes</a></li>
</ul>
<div class="bg">
...
<p align="center">You can see the quizzes you need to take in this table. If the quiz is available
  then you can take that quiz. If not, then it will say 'Quiz not available'. You can start the quiz you want by 
clicking the button in that row. The time starts as soon as you press the button. Good Luck Students! </p>
